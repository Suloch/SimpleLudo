...
function getGreenPath(height: number, width: number){
    ...
    const homePosition1 = {x: width - (offsetX + height / homePositionFactor - homeCellSzie + homeXDifference), y: height / homePositionFactor - homeCellSzie}
